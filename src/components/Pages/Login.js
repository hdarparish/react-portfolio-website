    ...
    <Container>
      ...
      <form className={classes.root} autoComplete="off" onSubmit={loginSubmit}>
        <div className="input-style">
          <TextField id="usernameEntry" className="input-style" label="Username" color="secondary" required value={username} onChange={e => setUsername(e.target.value)} />
        </div>
        ...
        <div>
          <Button className={classes.button} variant="contained" color="default" type="submit">Sign in</Button>
        </div>
